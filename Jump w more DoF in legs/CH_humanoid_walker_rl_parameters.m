...
params.stoppingCriteria.forward          = 4;   % (m)
params.stoppingCriteria.lateral          = 4;   % (m)
params.stoppingCriteria.angle            = 45;  % (deg)
params.stoppingCriteria.timeoutTime      = 2;   % (s)
params.stoppingCriteria.timeoutDistance  = 0.5;   % (m)

%% Reward scaling parameters

params.reward.forwardPenaltyWeight   = 15;    % Forward velocity scale, w_1
params.reward.timestepRewardWeight  = 1;    % Not falling scale, w_2
params.reward.powerPenaltyWeight    = 5e-4; % Power scale, w_3
params.reward.verticalRewardWeight = 50;   % Vertical displacement scale, w_4
params.reward.lateralPenaltyWeight  = 15;  % Lateral displacement scale, w_5
...
params.display.planeWidth        = 5;   % (m)
params.display.planeLength       = 5;  % (m)
