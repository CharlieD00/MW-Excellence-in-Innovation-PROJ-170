...
%% Save Parameters to a separate file
Peripherals.motor.RHTorque = 0.01;
Peripherals.motor.LHTorque = 0.01;
Peripherals.motor.RKTorque = 0.01;
Peripherals.motor.LKTorque = 0.01;
Peripherals.motor.RATorque = 0.01;
Peripherals.motor.LATorque = 0.01;
CH_humanoid_walker_rl_parameters
%% 
% Select model, based on training requirement or visualisation mode enabled

modelSelectTest = true;
retrain = true;

mdlName = 'CH_humanoid_walker_rl_GUI';

%if trainWalker == true

if modelSelectTest == true
    mdlName='CH_humanoid_walker_rl_GUI_NoBox';
end
...
% Define environment
load_system(mdlName);
blk = [mdlName,'/Walker-System/RL Agent'];
